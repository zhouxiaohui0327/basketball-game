        ...
        <nav>
            <ul class="pagination">
                ...
                <?php
                    ...
                    ?>
                    <li>
                        <a href="picture_mobile.php?id=<?php echo $id;?>&page=<?php echo $page - 1;?>" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>
                <?php
                ...
                <?php
                    ...
                    ?>
                    <li>
                        <a href="picture_mobile.php?id=<?php echo $id;?>&page=<?php echo $page + 1;?>" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                <?php
